...
<<dataconst_plot1, eval=TRUE, echo=FALSE, dev=c('png','pdf'), warning=FALSE, fig.cap="Distribution of absolute differences in least and greatest value of each of seven different altmetrics on a set of 565 DOIs from Altmetric, ImpactStory, and PLoS ALM. Values were log10 transformed to improve visual comprehension.">>=
library(ggplot2, quietly=TRUE)
library(reshape2, quietly=TRUE)
...
<<dataconst_plot2, eval=TRUE, echo=FALSE, dev=c('png','pdf'), warning=FALSE, fig.cap="Distribution of absolute differences in least and greatest value of each of seven different altmetrics on a set of 565 DOIs from Altmetric, ImpactStory, and PLoS ALM. Values were log10 transformed to improve visual comprehension.">>=
datediff <- function(x){
  datesorted <- sort(x)
...
<<dataconst2, eval=TRUE, echo=FALSE, dev=c('png','pdf'), warning=FALSE, fig.cap="A comparison of seven different altmetrics on a set of 20 DOIs from Altmetric, ImpactStory, and PLoS. This demonstrates how altmetrics can be very similar across providers for some DOIs, but very dissimilar for others.">>=
# Melt the data.frame 
